...
This project delivers a complete end-to-end analysis of employee attrition using the IBM HR dataset.

From data cleaning to final dashboards, the objective was to identify the drivers of employee turnover and provide actionable recommendations to improve retention.
...
Employee attrition is costly and disruptive.

This project answers key business questions:

Which employees are most likely to leave?

What factors drive attrition across departments and roles?

How do compensation, tenure, and satisfaction influence turnover?

What actions can management take to reduce attrition?

## 🛠️ Tools Used

Microsoft Excel → Analysis, Pivot Tables, KPI calculations

Power Query → Data cleaning and transformation

Tableau Public → Dashboard development and storytelling
...
Three dashboards were developed in Tableau:
...
Focus: HR Analytics | Finance Analytics | Business Intelligence
